...
use ProxmoxMG\Exception\AuthenticationException;

/**
 * ProxmoxMG class. In order to interact with the proxmox server, the desired
...
class Proxmox
{
    ...
    /**
     * Stores the ProxmoxMG user session such as ticket, username and csrf
     * prevention token, are all in there.
     *
     * @var \ProxmoxMG\AuthToken
     */
    private $authToken;
     ...
     *
     * @throws \ProxmoxMG\Exception\MalformedCredentialsException If bad args
     *                                                            supplied.
     * @throws \ProxmoxMG\Exception\AuthenticationException If given credentials
     *                                                      are not valid.
     */
    ...
    private function requestResource($actionPath, $params = [], $method = 'GET')
    {
        ...
        $cookies = CookieJar::fromArray([
            'PMGAuthCookie' => $this->authToken->getTicket(),
     ...
     *
     * @return \ProxmoxMG\AuthToken When successful login will return an
     *                              instance of the AuthToken class.
     *
     * @throws \ProxmoxMG\Exception\AuthenticationException If login fails.
     */
     ...
     *
     * @return \ProxmoxMG\Credentials Object containing all proxmox data used to
    ...
    /**
     * Assign the passed Credentials object to the ProxmoxMG.
     *
     * @param object $credentials A custom object holding credentials or a
     *                            Credentials object to assign.
     *
     * @throws \ProxmoxMG\Exception\AuthenticationException If can not login.
     */
